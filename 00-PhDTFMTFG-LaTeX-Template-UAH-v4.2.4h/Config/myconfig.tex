...
\newcommand{\myBookTitleSpanish}{JoularJX: Análisis y evaluación de una herramienta para la medición del consumo energético del software}
...
\newcommand{\myAuthorSurname}{Jiménez Crespo}
\newcommand{\myAuthorFullName}{\myAuthorName{} \myAuthorSurname{}}
\newcommand{\myAuthorGender}{male} 
\newcommand{\myAuthorEmail}{c.jimenezc@edu.uah.es}
\newcommand{\myAuthorDNI}{00000000-A}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Advisor data
\newcommand{\myAcademicTutorFullName}{Elena Katia Leal Algara} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Calendar dates 
\newcommand{\myThesisProposalDate}{20 de septiembre de 2026} % mes en minusculas "Anteproyecto" date

\newcommand{\myThesisDepositDate}{XX de XXXXX de 2027}
\newcommand{\myThesisDepositDateEnglish}{June 15\textsuperscript{th}, 2026}

% For RR, myThesisDefenseDate is date to be shown in the cover
\newcommand{\myThesisAcademicYear}{2024/2026}
\newcommand{\myThesisDefenseYear}{2027}
\newcommand{\myThesisDefenseDate}{XXXXXXXXXXX \myThesisDefenseYear{}}
