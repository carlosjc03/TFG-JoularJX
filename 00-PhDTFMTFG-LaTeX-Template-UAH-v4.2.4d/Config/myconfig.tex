...
\newcommand{\myAcademicTutorEmail}{katia.leal@uah.es}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Calendar dates 
\newcommand{\myThesisProposalDate}{16 de enero de 2025 CAMBIAR} % "Anteproyecto" date

\newcommand{\myThesisDepositDate}{15 de junio de 2025 CAMBIAR}
...
\newcommand{\myThesisDefenseDate}{24 de junio de CAMBIAR \myThesisDefenseYear{}}
